...
class Migration5 extends Migration {
  ...
  Future upgrade() async {
    database.createTable(SchemaTable("_ItogWork", [
    ...
    database.createTable(SchemaTable("_OperationCategory", [
      SchemaColumn("id", ManagedPropertyType.bigInteger,
          isPrimaryKey: true,
          autoincrement: true,
          isIndexed: false,
    ...
    database.addColumn(
        ...
        SchemaColumn.relationship(
            ...
            relatedTableName: "_OperationCategory",
            relatedColumnName: "id",
            rule: DeleteRule.cascade,
            isNullable: false,
            isUnique: false));
    database.deleteTable("itog_operation");
    database.deleteTable("itog_category");
    database.deleteTable("actions");
    database.alterColumn("_Action", "user", (c) {
      c.isNullable = false;
